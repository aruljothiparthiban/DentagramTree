        ...
        files:[
            {
                src:  [
                    ...
                    'angular-toastr/dist/toastr.min.js',
                    'angular-toastr/dist/toastr.min.css',
                ...
                dest: 'admin-app/public/lib/angular',
            ...
            },
            {
                ...
                dest: 'admin-app/public/lib/',
                cwd:  'bower_components',
                expand: true
            },
            {
                src:  [
                    'ngImgCrop/compile/ng-img-crop.js',
                    'ngImgCrop/compile/ng-img-crop.css'
                ],
                dest: 'admin-app/public/lib/ngImgCrop',
                cwd:  'bower_components',
                expand: true
            }
        ]
